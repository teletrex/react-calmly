...
const useUserReportPrefService = (dispatch, serviceEndpointUrl) => {

//  const userReportPrefUrl = serviceApi.user.userReporwtPref[serviceApi.user.userReportPref.selection];
  const userReportPrefUrl = serviceEndpointUrl;
