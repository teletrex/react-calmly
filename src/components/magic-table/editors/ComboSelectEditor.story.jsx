...
import ComboSelectEditor from './ComboSelectEditor';

export default {
  title: 'Components/ComboSelectEditor',
  component: ComboSelectEditor,
  parameters: {
    info : {
      text: `
    ** Properties **
...
const longMenu = 'abcdefghijklmnopqrstuvwxyz123456789'.split('').map(item=>({label:item,value:item}));
...
export const Default = () => <div className={"magictable-scroller"}><ComboSelectEditor
...
export const WithInitialValue = () => <div className={"magictable-scroller"}><ComboSelectEditor
  selectLabel={"Please choose a city"}
  initialValue={2}
  onCellChange={handleOnChange}
  onCellBlur={handleOnBlur}
...
export const WithInitialValueAndGrabMenuDataOnClick = () => {
  ...
  return (<div className={"magictable-scroller"}><ComboSelectEditor
    selectLabel={"Please choose a city"}
    initialValue={2}
